...
module.exports.getUserLogin = require('./getUserLogin');
module.exports.getQuizzes = require('./getQuizzes');
module.exports.searchCourse = require('./searchCourse');
module.exports.getCoursesBulkProgress = require('./getCoursesBulkProgress');
module.exports.updateLogin = require('./updateLogin');